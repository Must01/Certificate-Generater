            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 lg:p-10">
                    ...
                    <div class="grid lg:grid-cols-2 gap-4 sm:grid-cols-1">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/mustapha_bouddahr" target="_blank" class="flex items-center p-4 rounded-xl border border-gray-100 hover:border-pink-500 hover:shadow-md transition-all duration-300 group">
                        ...
                        <!-- Ko-fi -->
                        <a href="https://ko-fi.com/mustaphabouddahr" target="_blank" class="flex items-center p-4 rounded-xl border border-gray-100 hover:border-[#FF5E5B] hover:shadow-md transition-all duration-300 group">
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/in/mustapha-bouddahr-830787338/" target="_blank" class="flex items-center p-4 rounded-xl border border-gray-100 hover:border-[#50C9CE] hover:shadow-md transition-all duration-300 group">
                            <div class="w-12 h-12 bg-[#50C9CE]/10 rounded-xl flex items-center justify-center mr-4">
                                <svg class="w-6 h-6 text-[#2E382E]" fill="currentColor" viewBox="0 0 24 24">
